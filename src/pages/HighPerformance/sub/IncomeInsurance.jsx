...
import { getIncomeInsurance } from '../../../service/api';
import Comingsoon from '../../../components/Comingsoon';
import { BASE_URL, BASE_URL_ } from '../../../service/config';
function IncomeInsurance() {
    const [antiDoping, setantiDoping] = useState([]);
    const [htmlString, setHtmlString] = useState('');
console.log('antiDoping',antiDoping);

    const fetchantiDoping = async () => {
        const result = await getIncomeInsurance()
                ...
                <div>
                    ...
                    {antiDoping.coverImageUrl && antiDoping.coverImageUrl !== "" && antiDoping.coverImageUrl !== "null" && (
                        <div className='w-full'>
                            <img className='object-cover w-full' src={BASE_URL_ + `${antiDoping.coverImageUrl}`} alt='' />
                        </div>
                    )}
...
export default IncomeInsurance